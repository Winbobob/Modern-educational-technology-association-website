...
namespace dbamet.DAL
{
	...
	public partial class DownloadHistory
	{
		...
		public int Add(dbamet.Model.DownloadHistory model)
		{
			...
			strSql.Append("insert into DownloadHistory(");
			strSql.Append("customId,resourceName,downloadTime,resourceId)");
			strSql.Append(" values (");
			strSql.Append("@customId,@resourceName,@downloadTime,@resourceId)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@customId", SqlDbType.Char,8),
					new SqlParameter("@resourceName", SqlDbType.VarChar,50),
			...
			parameters[2].Value = model.downloadTime;
			parameters[3].Value = model.resourceId;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update DownloadHistory set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from DownloadHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public dbamet.Model.DownloadHistory GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,customId,resourceName,downloadTime,resourceId from DownloadHistory ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			dbamet.Model.DownloadHistory model=new dbamet.Model.DownloadHistory();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["downloadTime"]!=null && ds.Tables[0].Rows[0]["downloadTime"].ToString()!="")
				{
					model.downloadTime=DateTime.Parse(ds.Tables[0].Rows[0]["downloadTime"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,customId,resourceName,downloadTime,resourceId ");
			strSql.Append(" FROM DownloadHistory ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,customId,resourceName,downloadTime,resourceId ");
			strSql.Append(" FROM DownloadHistory ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM DownloadHistory ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from DownloadHistory T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "DownloadHistory";
