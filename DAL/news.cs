...
namespace dbamet.DAL
{
	...
	public partial class news
	{
		...
		public int Add(dbamet.Model.news model)
		{
			...
			strSql.Append("title,[content],type,category,time,[file])");
		...
		public dbamet.Model.news GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,title,[content],type,category,time,[file] from news ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			dbamet.Model.news model=new dbamet.Model.news();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,title,[content],type,category,time,[file] ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,title,[content],type,category,time,[file] ");
			strSql.Append(" FROM news ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
