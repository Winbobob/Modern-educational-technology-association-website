...
namespace dbamet.DAL
{
	...
	public partial class Admin
	{
		...
		public dbamet.Model.Admin GetModel(string uid)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 uid,upwd from Admin ");
			strSql.Append(" where uid=@uid ");
			SqlParameter[] parameters = {
					new SqlParameter("@uid", SqlDbType.VarChar,50)			};
			parameters[0].Value = uid;

			dbamet.Model.Admin model=new dbamet.Model.Admin();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["upwd"]!=null && ds.Tables[0].Rows[0]["upwd"].ToString()!="")
				{
